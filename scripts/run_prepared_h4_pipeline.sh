...
SEED_FILE="${PREPARED_H2_SEED_FILE:-${ROOT_DIR}/data/h2/seeds/diverse_pdf_seeds_v2.jsonl}"
TEACHER_CONFIG="${H2_TEACHER_CONFIG:-${ROOT_DIR}/data/h2/teachers.json}"
ROLLOUT_DIR="${PREPARED_H2_ROLLOUT_DIR:-${ROOT_DIR}/data/h2/rollouts_diverse_v2}"
EVAL_DIR="${PREPARED_H2_EVAL_DIR:-${ROOT_DIR}/data/h2/eval_diverse_v2}"
PATH_DIR="${PREPARED_H2_PATH_DIR:-${ROOT_DIR}/data/h2/eval_diverse_v2_path}"
DOCVERIFY_DIR="${PREPARED_H3_DOCVERIFY_DIR:-${ROOT_DIR}/data/h3/docverify_plus_diverse_v2}"
NEGATIVE_DIR="${PREPARED_H3_NEGATIVE_DIR:-${ROOT_DIR}/data/h3/negative_diverse_v2}"
DIVERSITY_DIR="${PREPARED_H4_DIVERSITY_DIR:-${ROOT_DIR}/data/h4/diversity_diverse_v2}"
